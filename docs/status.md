...
- Next checkpoint: **8.5g — Event boundary hardening**.
- Latest completed sub-step: **8.5f — Provider robustness and observability**.
- Planned next order: **8.5g — Event boundary hardening**, then **8.5h — Anthropic prompt-cache request audit** before Checkpoint 9.
...
- `learnings-rust/` currently includes notes `01` through `39`.
- `learnings-agent/` currently includes notes `01` through `15`.
